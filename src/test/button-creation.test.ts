...
describe('ButtonCreation', () => {
    it('create submit button with correct label', () => {
        // given
    ...
    it('create previous button with correct label', () => {
        // given
        const propertiesConfig = {
            buttons: [
                {
    ...
    it('create next button with correct label', () => {
        // given
        const propertiesConfig = {
            buttons: [
                {
    ...
    it('create close button with correct label', () => {
        // given
        const propertiesConfig = {
            buttons: [
                {
